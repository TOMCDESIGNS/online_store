...
<form class="form-inline text-center" action="brands.php" method="post">
  <label for="brandName">Add a Brand:</label>
  <div class="input-group">
   <input class="form-control" type="text" name="brandName" value="<?php if(isset($_POST['brandName'])){echo $_POST['brandName'];}else echo '';?>">   
   <div class="input-group-btn">
   <button type="submit button" class="btn btn-success" name="add_brand">Add Brand</button>
  </div>
   </div>    
   </form><hr>
   <?php
	     if(isset($_POST['add_brand'])){
			 ...
			 if($_POST['brandName']!==''){
				...
				$insert_brand="insert into brands (brand_name) values ('$bname')";
				 $result_insert=mysqli_query($db,$insert_brand);
